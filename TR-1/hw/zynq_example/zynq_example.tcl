...
#
# zynq_example.tcl: Tcl script for re-creating project 'zynq_example'
#
# Generated by Vivado on Wed Feb 28 13:47:11 -03 2024
...
#
# 1. This project restoration tcl script (zynq_example.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/felipe/zynq-projects/zynq_example/zynq_example.srcs/src/fibonacci.sv"
#    "/home/felipe/zynq-projects/zynq_example/zynq_example.srcs/src/fibonacci_bram.sv"
#    "/home/felipe/zynq-projects/zynq_example/zynq_example.srcs/src/zynq_example_top.sv"
#    "/home/felipe/zynq-projects/zynq_example/zynq_example.srcs/constrs_1/new/constraints_io.xdc"
#    "/home/felipe/zynq-projects/zynq_example/zynq_example.srcs/utils_1/imports/synth_1/zynq_example_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/zynq_example.srcs/src/fibonacci.sv"]"\
 "[file normalize "$origin_dir/zynq_example.srcs/src/fibonacci_bram.sv"]"\
 "[file normalize "$origin_dir/zynq_example.srcs/src/zynq_example_top.sv"]"\
 "[file normalize "$origin_dir/zynq_example.srcs/constrs_1/new/constraints_io.xdc"]"\
 "[file normalize "$origin_dir/zynq_example.srcs/utils_1/imports/synth_1/zynq_example_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "zynq_example"
...
set script_file "zynq_example.tcl"
...
set file "src/fibonacci_bram.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/zynq_example_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "zynq_example_top" -objects $obj
...
set file "[file normalize "$origin_dir/zynq_example.srcs/constrs_1/new/constraints_io.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/constraints_io.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/constraints_io.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/constraints_io.xdc]" -objects $obj
...
set file "synth_1/zynq_example_wrapper.dcp"
...
# Proc to create BD zynq_example
proc cr_bd_zynq_example { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zynq_example
...
cd#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#reset#qspi_fbclk#gpio[9]#gpio[10]#reset#gpio[12]#reset#gpio[14]#wp#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#rx#tx#tx#rx#scl#sda#mdc#mdio} \
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports peripheral_aresetn] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x41200000 -range 0x00002000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x41200000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x41200000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.23141",
   "Default View_TopLeft":"468,99",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 8 -x 2530 -y 210 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 8 -x 2530 -y 230 -defaultsOSRD
preplace port gpio_sw -pg 1 -lvl 8 -x 2530 -y 100 -defaultsOSRD
preplace port leds_8bits -pg 1 -lvl 8 -x 2530 -y 80 -defaultsOSRD
preplace port BRAM_PORTB_0 -pg 1 -lvl 0 -x -10 -y 620 -defaultsOSRD
preplace port port-id_FCLK_CLK0 -pg 1 -lvl 8 -x 2530 -y 350 -defaultsOSRD
preplace portBus peripheral_aresetn -pg 1 -lvl 8 -x 2530 -y 430 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 7 -x 2250 -y 290 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 6 -x 1820 -y 420 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 3 -x 840 -y 250 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 4 -x 1170 -y 440 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 5 -x 1460 -y 610 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 7 -x 2250 -y 90 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -x 470 -y 150 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 1 -x 150 -y 120 -defaultsOSRD
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 0 7 10 200 280 30 640 500 1010 300 NJ 300 NJ 300 1990
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 6 670 520 NJ 520 NJ 520 NJ 520 2000 450 2490J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 8 20 210 270 10 650 10 1000 310 NJ 310 1580 310 2010 440 2480
preplace netloc processing_system7_0_FCLK_RESET0_N 1 5 3 1590 320 2000J 430 2460
preplace netloc BRAM_PORTB_0_1 1 0 5 NJ 620 NJ 620 NJ 620 NJ 620 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 4 1 1300 440n
preplace netloc axi_dma_0_M_AXIS_MM2S 1 0 3 10 20 NJ 20 630
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 1 N 90
preplace netloc axi_dma_0_M_AXI_S2MM 1 2 1 N 110
preplace netloc axi_gpio_0_GPIO 1 7 1 NJ 80
preplace netloc axi_gpio_0_GPIO2 1 7 1 NJ 100
preplace netloc axi_interconnect_0_M00_AXI 1 3 4 980 70 NJ 70 NJ 70 NJ
preplace netloc axi_interconnect_0_M01_AXI 1 3 1 990 240n
preplace netloc axi_interconnect_0_M02_AXI 1 1 3 290 490 NJ 490 980
preplace netloc axi_interconnect_0_M03_AXI 1 3 4 N 280 NJ 280 NJ 280 NJ
preplace netloc axis_data_fifo_0_M_AXIS 1 1 1 N 120
preplace netloc processing_system7_0_DDR 1 7 1 NJ 210
preplace netloc processing_system7_0_FIXED_IO 1 7 1 NJ 230
preplace netloc processing_system7_0_M_AXI_GP0 1 2 6 660 530 NJ 530 NJ 530 NJ 530 NJ 530 2470
levelinfo -pg 1 -10 150 470 840 1170 1460 1820 2250 2530
pagesize -pg 1 -db -bbox -sgen -150 0 2750 920
"
}
...
# End of cr_bd_zynq_example()
cr_bd_zynq_example ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files zynq_example.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files zynq_example.bd ] 
set_property IS_ENABLED "1" [get_files zynq_example.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files zynq_example.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files zynq_example.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files zynq_example.bd ] 
set_property PFM_NAME "" [get_files zynq_example.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_example.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_example.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files zynq_example.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files zynq_example.bd ] 
set_property USED_IN_SIMULATION "1" [get_files zynq_example.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files zynq_example.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse zynq_example.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zynq_example.gen/sources_1/bd/zynq_example/hdl/zynq_example_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zynq_example.bd] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/zynq_example.srcs/utils_1/imports/synth_1/zynq_example_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zynq_example.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "/home/felipe/vivado_projects/zynq_example/zynq_example.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/felipe/vivado_projects/zynq_example/zynq_example.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
